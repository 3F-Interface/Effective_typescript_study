...
- Buffer의 타입 정의는 NodeJS 타입 선언을 설치해서 얻을 수 있습니다. (@type/node)
- Buffer는 NodeJS 개발자만 필요합니다.
- @type/node는 NodeJS와 타입스크립트를 동시에 사용하는 개발자만 관련됩니다.
...
- @type/node에 있는 Buffer 선언을 사용하지 않고, 필요한 부분만을 떼어 내어 명시했습니다. (CsvBuffer)
